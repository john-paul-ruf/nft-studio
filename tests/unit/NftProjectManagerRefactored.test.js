/**
 * NftProjectManagerRefactored Test Suite
 * Tests the refactored NftProjectManager that uses extracted services
 */

import NftProjectManager from '../../src/main/implementations/NftProjectManagerRefactored.js';
...
const testEnv = {
    ...
    log: (message) => {
        console.log(`[NftProjectManagerRefactored Test] ${message}`);
    },
    ...
    summary: () => {
        ...
        console.log(`\n📊 NftProjectManagerRefactored Test Results: ${passed}/${total} passed, ${failed} failed`);
 ...
 * Main test runner
 */
async function runNftProjectManagerRefactoredTests() {
    console.log('🧪 Starting NftProjectManagerRefactored Test Suite...\n');
...
export { runNftProjectManagerRefactoredTests };

// Run tests if this file is executed directly
if (import.meta.url === `file://${process.argv[1]}`) {
    runNftProjectManagerRefactoredTests().then(results => {
